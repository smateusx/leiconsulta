...
Vereador ou deputado cola o rascunho ou envia PDF, recebe um parecer (já existe, é parecida, ou o acervo está livre) com os termos em comum, e só então protocola. Cada consulta ganha um código (ex.: LC-2026-0001) e fica no histórico. Dá para imprimir o parecer, copiar o código, reconsultar, comparar o rascunho com a lei lado a lado e exportar o acervo em CSV. Há um exemplo em `exemplos/rascunho-silencio.txt`. Página **Ajuda** explica os três pareceres. O exemplo inicial usa **Cachoeira/BA**.
